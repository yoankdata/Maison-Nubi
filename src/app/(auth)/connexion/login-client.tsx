...
import { Eye, EyeOff, Mail, Lock, Sparkles, Loader2, AlertCircle } from "lucide-react";
...
export default function LoginClient() {
    ...
    const onSubmit = async (data: LoginFormData) => {
        ...
        try {
            ...
            // Redirection réussie
            router.refresh(); // Rafraîchir pour mettre à jour les Server Components
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50/50 px-4 py-12">
            <div className="w-full max-w-md space-y-8">
                ...
                {/* En-tête externe pour plus d'élégance */}
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-anthracite tracking-tight">Bienvenue</h2>
                ...
                <Card className="border-border/40 shadow-xl shadow-gray-200/50">
                    <CardContent className="pt-8 px-6 sm:px-8">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link
                                        ...
                                        className="text-xs font-medium text-gold hover:text-gold-dark hover:underline transition-all"
                                    >
                                        Oublié ?
                                    </Link>
                                </div>
                        ...
                        <div className="relative my-8">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-white px-3 text-muted-foreground font-medium tracking-wider">Ou continuer avec</span>
                            </div>
                        </div>
                    ...
                    <CardFooter className="bg-gray-50/50 py-4 px-6 border-t border-gray-100 flex justify-center rounded-b-xl">
                        <p className="text-sm text-muted-foreground">
                            ...
                            <Link href="/inscription" className="font-semibold text-gold hover:text-gold-dark hover:underline transition-all">
